...
/******************************************************************************/
#define AI_MOD_MODEL_NAME          "mod"
#define AI_MOD_ORIGIN_MODEL_NAME   "pred_model"

/******************************************************************************/
#define AI_MOD_ACTIVATIONS_ALIGNMENT   (4)
#define AI_MOD_INPUTS_IN_ACTIVATIONS   (4)
#define AI_MOD_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_MOD_IN_NUM        (1)

AI_DEPRECATED
#define AI_MOD_IN \
  ai_mod_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_MOD_IN_SIZE { \
  AI_MOD_IN_1_SIZE, \
}
#define AI_MOD_IN_SIZE_BYTES { \
  AI_MOD_IN_1_SIZE_BYTES, \
}
#define AI_MOD_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MOD_IN_1_CHANNEL     (5)
#define AI_MOD_IN_1_SIZE        (5)
#define AI_MOD_IN_1_SIZE_BYTES  (20)

/******************************************************************************/
#define AI_MOD_OUT_NUM       (1)

AI_DEPRECATED
#define AI_MOD_OUT \
  ai_mod_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_MOD_OUT_SIZE { \
  AI_MOD_OUT_1_SIZE, \
}
#define AI_MOD_OUT_SIZE_BYTES { \
  AI_MOD_OUT_1_SIZE_BYTES, \
}
#define AI_MOD_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MOD_OUT_1_CHANNEL     (5)
#define AI_MOD_OUT_1_SIZE        (5)
#define AI_MOD_OUT_1_SIZE_BYTES  (20)

/******************************************************************************/
#define AI_MOD_N_NODES (8)
 ...
 * @ref ai_mod_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_MOD_*
 * defines into file @ref mod.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
